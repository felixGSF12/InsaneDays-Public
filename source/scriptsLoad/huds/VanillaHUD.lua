...
prototypeText = true -- if you want the prototype game watermark, like the "leaked" builds. 
...
ComboText = true -- shows "COMBO" aside to the song's combo numbers when you get a combo streak of 10.
...
setProperty("iconP1.x", getProperty("iconP1.x")-30)
removeLuaText('healthText',true);
removeLuaSprite('Health',true);
end
end
