...
local colorRatings = false  -- Color the ratings based on rating, Sick is blue, good is green, etc
local colorSyncing = false -- Rating takes color of direction | Overwrites colorRatings
