...
/**
 * ESTA CLASE YA NO SE USA, ESTA TODAVIA EN EL CODIGO FUENTE PORQUE POR 
 *
 * ALGUNA RAZON "CallOnLuas" deja de funcionar
 * 
 * usa "Achievement.hx" no "Achievements.hx".
 * 
 * osea sin la "s" al final XD
 */
class Achievements {
		public static var achievementsStuff:Array<Dynamic> = [
			...
			["Amor Visible!", "No dejes que Felix se haga invisible!", 'visible_felix', false],
		...
		public static function unlockAchievement(name:String):Void {
			...
			saveAchievements(); // Guarda los logros al desbloquear uno nuevo
		}
		...
		public static function loadAchievements():Void {
			...
			if(FlxG.save.data != null) {
				trace("Save data exists.");
				if(FlxG.save.data.achievementsMap != null) {
					trace("Achievements map exists in save data.");
					achievementsMap = FlxG.save.data.achievementsMap;
					trace("Loaded achievements map: " + achievementsMap.toString());
				} else {
					trace("Achievements map is null.");
				}
				if(henchmenDeath == 0 && FlxG.save.data.henchmenDeath != null) {
					trace("Loading henchmen deaths.");
					henchmenDeath = FlxG.save.data.henchmenDeath;
				}
			} else {
				trace("Save data is null.");
			}
		}
		...
		public static function saveAchievements():Void {
			if (FlxG.save.data != null) {
				...
				FlxG.save.flush(); // Asegura que los datos se escriban en el disco
			}
		}
	}
