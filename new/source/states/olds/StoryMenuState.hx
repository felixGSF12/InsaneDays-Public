...
class StoryMenuState extends MusicBeatState
{
	...
	var bg:FlxSprite = new FlxSprite(0, 0).loadGraphic(Paths.image('StoryMe/y mi corazon tucun tucun tucun'));
		...
		leftArrow = new FlxSprite(grpWeekText.members[0].x + grpWeekText.members[0].width - 290, grpWeekText.members[0].y + 87);
		...
		rightArrow = new FlxSprite(leftArrow.x + 486, leftArrow.y);
		...
		var tracksSprite:FlxSprite = new FlxSprite(FlxG.width * 0.07 + 100, bgSprite.y + 405).loadGraphic(Paths.image('Menu_Tracks'));
